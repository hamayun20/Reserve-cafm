...
export const fallbackData = {
  ...
  housing: {
    properties: [{ id: "hp1", code: "HSP-001", name: "Reserve Housing Village", site: "Jazan", city: "Jazan", manager: "Housing Supervisor", totalRooms: 2, active: true }],
    blocks: [{ id: "hb1", code: "HSB-A", name: "Block A", propertyId: "hp1", floors: 3, property: { name: "Reserve Housing Village" } }],
    rooms: [
      { id: "hr1", code: "HSR-A101", roomNumber: "A101", propertyId: "hp1", blockId: "hb1", floor: "1", roomType: "Single", capacity: 1, occupancy: 1, status: "OCCUPIED", qrCode: "QR:HSR-A101", property: { name: "Reserve Housing Village" }, block: { name: "Block A" }, beds: [] },
      { id: "hr2", code: "HSR-A102", roomNumber: "A102", propertyId: "hp1", blockId: "hb1", floor: "1", roomType: "Shared", capacity: 2, occupancy: 1, status: "RESERVED", qrCode: "QR:HSR-A102", property: { name: "Reserve Housing Village" }, block: { name: "Block A" }, beds: [] },
    ],
    beds: [{ id: "bed1", code: "HSR-A101-B1", label: "Bed 1", roomId: "hr1", status: "OCCUPIED", occupant: "Hamayun Ali" }],
    residents: [{ id: "res1", residentNo: "RES-00001", name: "Hamayun Ali", email: "resident@example.com", phone: "+966500000000", companyId: "RES-001", nationality: "Pakistan", departmentCode: "MEP", status: "ACTIVE" }],
    bookings: [{ id: "bk1", bookingNo: "HBK-00001", residentName: "Hamayun Ali", departmentCode: "MEP", roomId: "hr1", bedId: "bed1", checkIn: new Date(), status: "CHECKED_IN", priority: "MEDIUM", requestedBy: "Admin", room: { roomNumber: "A101", property: { name: "Reserve Housing Village" }, block: { name: "Block A" } }, bed: { label: "Bed 1" }, approvals: [] }],
    inspections: [{ id: "hin1", inspectionNo: "HIN-00001", roomId: "hr1", inspector: "Housing Supervisor", inspectionType: "Check-in", status: "PASSED", score: 96, findings: "Room ready", dueAt: new Date(), room: { roomNumber: "A101", property: { name: "Reserve Housing Village" } } }],
    assets: [{ id: "ha1", tag: "HSA-00001", name: "Bed Frame", category: "Furniture", roomId: "hr1", status: "ACTIVE", qrCode: "QR:HSA-00001" }],
    inventory: [{ id: "hi1", sku: "HSI-LINEN-001", name: "Linen Set", category: "Linen", roomId: "hr1", storeLocation: "Housing Store / Linen Rack A", onHand: 24, minimumStock: 12, reorderPoint: 10, unit: "Set", supplierName: "Reserve Housekeeping Supplies", expiryDate: new Date(), purchaseRequestStatus: "NOT_REQUIRED", lastMovementType: "RECEIPT", qrCode: "QR:HSI-LINEN-001" }],
    approvals: [],
